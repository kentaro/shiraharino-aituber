...
FALLBACK = [
    {"theme": "夜のひとりごと", "text": "夜がふけてきましたね。静かな時間です。"},
    {"theme": "テック雑記", "text": "知らないことは、可能性のかたまり。"},
    {"theme": "観測ログ", "text": "今日も、小さな変化を見つけました。"},
    {"theme": "今日のことば", "text": "急がなくていい。ちゃんと進んでいます。"},
    {"theme": "季節のうつろい", "text": "風のにおいが、少し変わってきました。"},
    {"theme": "宇宙と時間", "text": "時間って、不思議ですね。"},
]
...
def gen_box(n, recent):
    ...
    prompt = (f"{PERSONA}\n\n配信で話す独り言を{n}個作って。"
              f"各1〜2文・25〜45字の短い一言（テロップに収まる長さ）。絵文字や記号やかっこ書きなし。"
...
def gen_gemini(n, recent):
    if not GEMINI_KEY:
        return None
    avoid = " / ".join(recent[-6:]) if recent else "（なし）"
    prompt = (f"{PERSONA}\n\n配信で話す独り言を{n}個作って。各1〜2文・25〜45字の短い一言・記号や絵文字なし。"
